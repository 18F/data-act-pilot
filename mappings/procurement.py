...
#   ../schema/xbrl/procurement/da-procurement-content-2015-06-29.xsd
#
# Command line:
#   /Users/rebeccasweger/Dev/.virtualenvs/intercessor/lib/python2.7/site-packages/generateDS-2.17a0/generateDS.py -o "procurement.py" -q -f --no-dates --no-versions ../schema/xbrl/procurement/da-procurement-content-2015-06-29.xsd
#
...
class awardComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='awardComplexType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:award="http://www.xbrl.org/int/award/2006-10-25"  xmlns:gen="http://www.xbrl.org/int/gl/gen/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='awardComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='awardComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_format_string(quote_attrib(self.id).encode(ExternalEncoding), input_name='id'), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='awardComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.awardeeInformation is not None:
            self.awardeeInformation.export(outfile, level, namespace_='proc:', name_='awardeeInformation', pretty_print=pretty_print)
        ...
        if self.periodOfPerformance is not None:
            self.periodOfPerformance.export(outfile, level, namespace_='proc:', name_='periodOfPerformance', pretty_print=pretty_print)
        ...
        if self.awardAmounts is not None:
            self.awardAmounts.export(outfile, level, namespace_='proc:', name_='awardAmounts', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
...
class awardAmountsComplexType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, id=None, federalFundingAmount=None, currentTotalValueOfAward=None, potentialTotalValueOfAward=None):
        self.original_tagname_ = None
        self.id = _cast(None, id)
        self.federalFundingAmount = federalFundingAmount
        self.currentTotalValueOfAward = currentTotalValueOfAward
        self.potentialTotalValueOfAward = potentialTotalValueOfAward
    def factory(*args_, **kwargs_):
    ...
    def get_currentTotalValueOfAward(self): return self.currentTotalValueOfAward
    def set_currentTotalValueOfAward(self, currentTotalValueOfAward): self.currentTotalValueOfAward = currentTotalValueOfAward
    def get_potentialTotalValueOfAward(self): return self.potentialTotalValueOfAward
    def set_potentialTotalValueOfAward(self, potentialTotalValueOfAward): self.potentialTotalValueOfAward = potentialTotalValueOfAward
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def hasContent_(self):
        if (
            self.federalFundingAmount is not None or
            self.currentTotalValueOfAward is not None or
            self.potentialTotalValueOfAward is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='proc:', name_='awardAmountsComplexType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:award="http://www.xbrl.org/int/award/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='awardAmountsComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='awardAmountsComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_format_string(quote_attrib(self.id).encode(ExternalEncoding), input_name='id'), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='awardAmountsComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.currentTotalValueOfAward is not None:
            self.currentTotalValueOfAward.export(outfile, level, namespace_='proc:', name_='currentTotalValueOfAward', pretty_print=pretty_print)
        if self.potentialTotalValueOfAward is not None:
            self.potentialTotalValueOfAward.export(outfile, level, namespace_='proc:', name_='potentialTotalValueOfAward', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'currentTotalValueOfAward':
            obj_ = amountItemType.factory()
            obj_.build(child_)
            self.currentTotalValueOfAward = obj_
            obj_.original_tagname_ = 'currentTotalValueOfAward'
        elif nodeName_ == 'potentialTotalValueOfAward':
            obj_ = amountItemType.factory()
            obj_.build(child_)
            self.potentialTotalValueOfAward = obj_
            obj_.original_tagname_ = 'potentialTotalValueOfAward'
...
class awardeeInformationComplexType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, id=None, businessType=None, awardeeLegalBusinessName=None, ultimateParentUniqueIdentifier=None, awardeeUniqueIdentifier=None, awardeeUniqueIdentifierSupplemental=None, ultimateParentLegalBusinessName=None, awardeeAddress=None, awardeenaics=None):
        self.original_tagname_ = None
        self.id = _cast(None, id)
        ...
        self.awardeenaics = awardeenaics
    def factory(*args_, **kwargs_):
    ...
    def get_awardeenaics(self): return self.awardeenaics
    def set_awardeenaics(self, awardeenaics): self.awardeenaics = awardeenaics
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def hasContent_(self):
        if (
            ...
            self.awardeeAddress is not None or
            self.awardeenaics is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='proc:', name_='awardeeInformationComplexType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:award="http://www.xbrl.org/int/award/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='awardeeInformationComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='awardeeInformationComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_format_string(quote_attrib(self.id).encode(ExternalEncoding), input_name='id'), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='awardeeInformationComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.awardeenaics is not None:
            self.awardeenaics.export(outfile, level, namespace_='proc:', name_='awardeenaics', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'awardeenaics':
            obj_ = naicsComplexType.factory()
            obj_.build(child_)
            self.awardeenaics = obj_
            obj_.original_tagname_ = 'awardeenaics'
# end class awardeeInformationComplexType


class naicsComplexType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, id=None, naicsNumber=None, naicsDescription=None):
        self.original_tagname_ = None
        self.id = _cast(None, id)
        self.naicsNumber = naicsNumber
        self.naicsDescription = naicsDescription
    def factory(*args_, **kwargs_):
        if naicsComplexType.subclass:
            return naicsComplexType.subclass(*args_, **kwargs_)
        else:
            return naicsComplexType(*args_, **kwargs_)
    factory = staticmethod(factory)
    def get_naicsNumber(self): return self.naicsNumber
    def set_naicsNumber(self, naicsNumber): self.naicsNumber = naicsNumber
    def get_naicsDescription(self): return self.naicsDescription
    def set_naicsDescription(self, naicsDescription): self.naicsDescription = naicsDescription
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def hasContent_(self):
        if (
            self.naicsNumber is not None or
            self.naicsDescription is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='proc:', name_='naicsComplexType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('<%s%s%s' % (namespace_, name_, namespacedef_ and ' ' + namespacedef_ or '', ))
        already_processed = set()
        self.exportAttributes(outfile, level, already_processed, namespace_, name_='naicsComplexType')
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='naicsComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='naicsComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_format_string(quote_attrib(self.id).encode(ExternalEncoding), input_name='id'), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='naicsComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        if self.naicsNumber is not None:
            self.naicsNumber.export(outfile, level, namespace_='proc:', name_='naicsNumber', pretty_print=pretty_print)
        if self.naicsDescription is not None:
            self.naicsDescription.export(outfile, level, namespace_='proc:', name_='naicsDescription', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildAttributes(self, node, attrs, already_processed):
        ...
        if value is not None and 'id' not in already_processed:
            ...
            self.id = value
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'naicsNumber':
            obj_ = integerItemType.factory()
            obj_.build(child_)
            self.naicsNumber = obj_
            obj_.original_tagname_ = 'naicsNumber'
        elif nodeName_ == 'naicsDescription':
            obj_ = stringItemType.factory()
            obj_.build(child_)
            self.naicsDescription = obj_
            obj_.original_tagname_ = 'naicsDescription'
# end class naicsComplexType


class periodOfPerformanceComplexType(GeneratedsSuper):
    subclass = None
    superclass = None
    def __init__(self, id=None, periodOfPerformanceActionDate=None, periodOfPerformanceStartDate=None, periodOfPerformanceCurrentEndDate=None, periodOfPerformancePotentialEndDate=None, periodOfPerformanceOrderingPeriodEndDate=None):
        self.original_tagname_ = None
        self.id = _cast(None, id)
        ...
        self.periodOfPerformanceOrderingPeriodEndDate = periodOfPerformanceOrderingPeriodEndDate
    def factory(*args_, **kwargs_):
    ...
    def get_periodOfPerformanceOrderingPeriodEndDate(self): return self.periodOfPerformanceOrderingPeriodEndDate
    def set_periodOfPerformanceOrderingPeriodEndDate(self, periodOfPerformanceOrderingPeriodEndDate): self.periodOfPerformanceOrderingPeriodEndDate = periodOfPerformanceOrderingPeriodEndDate
    def get_id(self): return self.id
    def set_id(self, id): self.id = id
    def hasContent_(self):
        if (
            ...
            self.periodOfPerformancePotentialEndDate is not None or
            self.periodOfPerformanceOrderingPeriodEndDate is not None
        ):
            return True
        else:
            return False
    def export(self, outfile, level, namespace_='proc:', name_='periodOfPerformanceComplexType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:award="http://www.xbrl.org/int/award/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='periodOfPerformanceComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='periodOfPerformanceComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_format_string(quote_attrib(self.id).encode(ExternalEncoding), input_name='id'), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='periodOfPerformanceComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.periodOfPerformanceOrderingPeriodEndDate is not None:
            self.periodOfPerformanceOrderingPeriodEndDate.export(outfile, level, namespace_='proc:', name_='periodOfPerformanceOrderingPeriodEndDate', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        ...
        elif nodeName_ == 'periodOfPerformanceOrderingPeriodEndDate':
            obj_ = dateItemType.factory()
            obj_.build(child_)
            self.periodOfPerformanceOrderingPeriodEndDate = obj_
            obj_.original_tagname_ = 'periodOfPerformanceOrderingPeriodEndDate'
...
class decimalItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='decimalItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='decimalItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='decimalItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='decimalItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class floatItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='floatItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='floatItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='floatItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='floatItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class doubleItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='doubleItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='doubleItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='doubleItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='doubleItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class monetaryItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='monetaryItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='monetaryItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='monetaryItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='monetaryItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class sharesItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='sharesItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='sharesItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='sharesItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='sharesItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class pureItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='pureItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='pureItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='pureItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='pureItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class fractionItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='fractionItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='fractionItemType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='fractionItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.id is not None and 'id' not in already_processed:
        ...
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='fractionItemType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class integerItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='integerItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='integerItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='integerItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='integerItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class nonPositiveIntegerItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='nonPositiveIntegerItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='nonPositiveIntegerItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='nonPositiveIntegerItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='nonPositiveIntegerItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class negativeIntegerItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='negativeIntegerItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='negativeIntegerItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='negativeIntegerItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='negativeIntegerItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class longItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='longItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='longItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='longItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='longItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class intItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='intItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='intItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='intItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='intItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class shortItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='shortItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='shortItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='shortItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='shortItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class byteItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='byteItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='byteItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='byteItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='byteItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class nonNegativeIntegerItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='nonNegativeIntegerItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='nonNegativeIntegerItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='nonNegativeIntegerItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='nonNegativeIntegerItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class unsignedLongItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='unsignedLongItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='unsignedLongItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='unsignedLongItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='unsignedLongItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class unsignedIntItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='unsignedIntItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='unsignedIntItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='unsignedIntItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='unsignedIntItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class unsignedShortItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='unsignedShortItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='unsignedShortItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='unsignedShortItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='unsignedShortItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class unsignedByteItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='unsignedByteItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='unsignedByteItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='unsignedByteItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='unsignedByteItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class positiveIntegerItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='positiveIntegerItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='positiveIntegerItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='positiveIntegerItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='positiveIntegerItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class stringItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='stringItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='stringItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='stringItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='stringItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class booleanItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='booleanItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='booleanItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='booleanItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='booleanItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class hexBinaryItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='hexBinaryItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='hexBinaryItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='hexBinaryItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='hexBinaryItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class base64BinaryItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='base64BinaryItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='base64BinaryItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='base64BinaryItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='base64BinaryItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class anyURIItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='anyURIItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='anyURIItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='anyURIItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='anyURIItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class QNameItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='QNameItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='QNameItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='QNameItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='QNameItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class durationItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='durationItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='durationItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='durationItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='durationItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class dateTimeItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='dateTimeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='dateTimeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='dateTimeItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='dateTimeItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class timeItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='timeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='timeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='timeItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='timeItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class dateItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='dateItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='dateItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='dateItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='dateItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class gYearMonthItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='gYearMonthItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='gYearMonthItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='gYearMonthItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='gYearMonthItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class gYearItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='gYearItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='gYearItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='gYearItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='gYearItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class gMonthDayItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='gMonthDayItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='gMonthDayItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='gMonthDayItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='gMonthDayItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class gDayItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='gDayItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='gDayItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='gDayItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='gDayItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class gMonthItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='gMonthItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='gMonthItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='gMonthItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='gMonthItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class normalizedStringItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='normalizedStringItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='normalizedStringItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='normalizedStringItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='normalizedStringItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class tokenItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='tokenItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='tokenItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='tokenItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def exportChildren(self, outfile, level, namespace_='proc:', name_='tokenItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class languageItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='languageItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='languageItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='languageItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='languageItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class NameItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='NameItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='NameItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='NameItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='NameItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class NCNameItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='NCNameItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='NCNameItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='NCNameItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='NCNameItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class segment(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='segment', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='segment', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='segment'):
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='segment', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class contextEntityType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='contextEntityType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='contextEntityType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='contextEntityType'):
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='contextEntityType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class contextPeriodType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='contextPeriodType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='contextPeriodType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='contextPeriodType'):
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='contextPeriodType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class contextScenarioType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='contextScenarioType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='contextScenarioType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='contextScenarioType'):
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='contextScenarioType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class context(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='context', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='context', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='context'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='context', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class measuresType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='measuresType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='measuresType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='measuresType'):
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='measuresType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class divide(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='divide', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='divide', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='divide'):
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='divide', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class unit(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='unit', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='unit', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='unit'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='unit', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class xbrl(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='xbrl', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='xbrl', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='xbrl'):
        unique_counter = 0
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='xbrl', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class presentationLink(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='presentationLink', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='presentationLink', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='presentationLink'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='presentationLink', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class definitionLink(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='definitionLink', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='definitionLink', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='definitionLink'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='definitionLink', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class calculationLink(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='calculationLink', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='calculationLink', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='calculationLink'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='calculationLink', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class labelLink(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='labelLink', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='labelLink', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='labelLink'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='labelLink', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class referenceLink(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='referenceLink', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='referenceLink', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='referenceLink'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='referenceLink', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class footnoteLink(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='footnoteLink', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='footnoteLink', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='footnoteLink'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='footnoteLink', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class linkbase(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='linkbase', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='linkbase', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='linkbase'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='linkbase', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class linkbaseRef(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='linkbaseRef', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='linkbaseRef', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='linkbaseRef'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='linkbaseRef', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class roleType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='roleType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='roleType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='roleType'):
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='roleType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class arcroleType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='arcroleType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='arcroleType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='arcroleType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='arcroleType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class documentationType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='documentationType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='documentationType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='documentationType'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='documentationType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class titleType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='titleType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='titleType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='titleType'):
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_format_string(quote_attrib(self.type_).encode(ExternalEncoding), input_name='type'), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='titleType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class locatorType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='locatorType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='locatorType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='locatorType'):
        ...
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_format_string(quote_attrib(self.type_).encode(ExternalEncoding), input_name='type'), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='locatorType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class arcType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='arcType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='arcType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='arcType'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def exportChildren(self, outfile, level, namespace_='proc:', name_='arcType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class resourceType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='resourceType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='resourceType'):
        if self.role is not None and 'role' not in already_processed:
            already_processed.add('role')
            outfile.write(' role=%s' % (self.gds_format_string(quote_attrib(self.role).encode(ExternalEncoding), input_name='role'), ))
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def exportChildren(self, outfile, level, namespace_='proc:', name_='resourceType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class extendedType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='extendedType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='extendedType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='extendedType'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
        ...
        if self.title_attr is not None and 'title_attr' not in already_processed:
            already_processed.add('title_attr')
            outfile.write(' title=%s' % (self.gds_format_string(quote_attrib(self.title_attr).encode(ExternalEncoding), input_name='title_attr'), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='extendedType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class simpleType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='simpleType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='simpleType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='simpleType'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def exportChildren(self, outfile, level, namespace_='proc:', name_='simpleType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class accountPurposeCodeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='accountPurposeCodeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='accountPurposeCodeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='accountPurposeCodeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='accountPurposeCodeItemType', fromsubclass_=False, pretty_print=True):
...
class accountTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='accountTypeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='accountTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='accountTypeItemType'):
        super(accountTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='accountTypeItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='accountTypeItemType', fromsubclass_=False, pretty_print=True):
...
class bookTaxDifferenceItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='bookTaxDifferenceItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='bookTaxDifferenceItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='bookTaxDifferenceItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='bookTaxDifferenceItemType', fromsubclass_=False, pretty_print=True):
...
class identifierOrganizationTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='identifierOrganizationTypeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='identifierOrganizationTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='identifierOrganizationTypeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='identifierOrganizationTypeItemType', fromsubclass_=False, pretty_print=True):
...
class debitCreditCodeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='debitCreditCodeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='debitCreditCodeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='debitCreditCodeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='debitCreditCodeItemType', fromsubclass_=False, pretty_print=True):
...
class documentTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='documentTypeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='documentTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='documentTypeItemType'):
        super(documentTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='documentTypeItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='documentTypeItemType', fromsubclass_=False, pretty_print=True):
...
class invoiceTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='invoiceTypeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='invoiceTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='invoiceTypeItemType'):
        super(invoiceTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='invoiceTypeItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='invoiceTypeItemType', fromsubclass_=False, pretty_print=True):
...
class entriesTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='entriesTypeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='entriesTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='entriesTypeItemType'):
        super(entriesTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='entriesTypeItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='entriesTypeItemType', fromsubclass_=False, pretty_print=True):
...
class entryTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='entryTypeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='entryTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='entryTypeItemType'):
        super(entryTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='entryTypeItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='entryTypeItemType', fromsubclass_=False, pretty_print=True):
...
class identifierTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='identifierTypeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='identifierTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='identifierTypeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='identifierTypeItemType', fromsubclass_=False, pretty_print=True):
...
class mainAccountTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='mainAccountTypeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='mainAccountTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='mainAccountTypeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='mainAccountTypeItemType', fromsubclass_=False, pretty_print=True):
...
class postingStatusItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='postingStatusItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='postingStatusItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='postingStatusItemType'):
        super(postingStatusItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='postingStatusItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='postingStatusItemType', fromsubclass_=False, pretty_print=True):
...
class qualifierEntryItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='qualifierEntryItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='qualifierEntryItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='qualifierEntryItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='qualifierEntryItemType', fromsubclass_=False, pretty_print=True):
...
class revisesUniqueIDActionItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='revisesUniqueIDActionItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='revisesUniqueIDActionItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='revisesUniqueIDActionItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='revisesUniqueIDActionItemType', fromsubclass_=False, pretty_print=True):
...
class signOfAmountItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='signOfAmountItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='signOfAmountItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='signOfAmountItemType'):
        super(signOfAmountItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='signOfAmountItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='signOfAmountItemType', fromsubclass_=False, pretty_print=True):
...
class sourceJournalIDItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='sourceJournalIDItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='sourceJournalIDItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='sourceJournalIDItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='sourceJournalIDItemType', fromsubclass_=False, pretty_print=True):
...
class xbrlIncludeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='xbrlIncludeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='xbrlIncludeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='xbrlIncludeItemType'):
        super(xbrlIncludeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='xbrlIncludeItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='xbrlIncludeItemType', fromsubclass_=False, pretty_print=True):
...
class phoneNumberDescriptionItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='phoneNumberDescriptionItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='phoneNumberDescriptionItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='phoneNumberDescriptionItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='phoneNumberDescriptionItemType', fromsubclass_=False, pretty_print=True):
...
class availableTypeCodeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='availableTypeCodeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='availableTypeCodeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='availableTypeCodeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='availableTypeCodeItemType', fromsubclass_=False, pretty_print=True):
...
class TreasuryAccountSymbolComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='TreasuryAccountSymbolComplexType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:gen="http://www.xbrl.org/int/gl/gen/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='TreasuryAccountSymbolComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='TreasuryAccountSymbolComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='TreasuryAccountSymbolComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class addressComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='addressComplexType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:gen="http://www.xbrl.org/int/gl/gen/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='addressComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='addressComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='addressComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class streetAddressComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='streetAddressComplexType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:gen="http://www.xbrl.org/int/gl/gen/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='streetAddressComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='streetAddressComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='streetAddressComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class agencyComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='agencyComplexType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:gen="http://www.xbrl.org/int/gl/gen/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='agencyComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='agencyComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='agencyComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class agencyOfficeComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='agencyOfficeComplexType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:gen="http://www.xbrl.org/int/gl/gen/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='agencyOfficeComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='agencyOfficeComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='agencyOfficeComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class amountItemType(monetaryItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='amountItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='amountItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='amountItemType'):
        super(amountItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='amountItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='amountItemType', fromsubclass_=False, pretty_print=True):
...
class congressionalDistrictItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='congressionalDistrictItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='congressionalDistrictItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='congressionalDistrictItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='congressionalDistrictItemType', fromsubclass_=False, pretty_print=True):
...
class stateItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='stateItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='stateItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='stateItemType'):
        super(stateItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='stateItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='stateItemType', fromsubclass_=False, pretty_print=True):
...
class businessTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='businessTypeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='businessTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='businessTypeItemType'):
        super(businessTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='businessTypeItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='businessTypeItemType', fromsubclass_=False, pretty_print=True):
...
class recordTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='recordTypeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='recordTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='recordTypeItemType'):
        super(recordTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='recordTypeItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='recordTypeItemType', fromsubclass_=False, pretty_print=True):
...
class typeOfActionItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='typeOfActionItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='typeOfActionItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='typeOfActionItemType'):
        super(typeOfActionItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='typeOfActionItemType')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='typeOfActionItemType', fromsubclass_=False, pretty_print=True):
...
class typeOfTransactionCodeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='typeOfTransactionCodeItemType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='typeOfTransactionCodeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='typeOfTransactionCodeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='typeOfTransactionCodeItemType', fromsubclass_=False, pretty_print=True):
...
class highlyCompensatedOfficerComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='highlyCompensatedOfficerComplexType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25" xmlns:award="http://www.xbrl.org/int/award/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='highlyCompensatedOfficerComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='highlyCompensatedOfficerComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_format_string(quote_attrib(self.id).encode(ExternalEncoding), input_name='id'), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='highlyCompensatedOfficerComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class identifierType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='identifierType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='identifierType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='identifierType'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='identifierType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class foreverType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='foreverType', namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='foreverType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='foreverType'):
        pass
    def exportChildren(self, outfile, level, namespace_='proc:', name_='foreverType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class arcroleRef(simpleType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='arcroleRef', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='arcroleRef', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='arcroleRef'):
        super(arcroleRef, self).exportAttributes(outfile, level, already_processed, namespace_, name_='arcroleRef')
        if self.arcroleURI is not None and 'arcroleURI' not in already_processed:
            already_processed.add('arcroleURI')
            outfile.write(' arcroleURI=%s' % (quote_attrib(self.arcroleURI), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='arcroleRef', fromsubclass_=False, pretty_print=True):
...
class roleRef(simpleType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='roleRef', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='roleRef', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='roleRef'):
        super(roleRef, self).exportAttributes(outfile, level, already_processed, namespace_, name_='roleRef')
        if self.roleURI is not None and 'roleURI' not in already_processed:
            already_processed.add('roleURI')
            outfile.write(' roleURI=%s' % (quote_attrib(self.roleURI), ))
    def exportChildren(self, outfile, level, namespace_='proc:', name_='roleRef', fromsubclass_=False, pretty_print=True):
...
class footnote(resourceType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='footnote', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='footnote', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='footnote'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='footnote', fromsubclass_=False, pretty_print=True):
...
class reference(resourceType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='reference', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='reference', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='reference'):
        super(reference, self).exportAttributes(outfile, level, already_processed, namespace_, name_='reference')
    def exportChildren(self, outfile, level, namespace_='proc:', name_='reference', fromsubclass_=False, pretty_print=True):
...
class label(resourceType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='label', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='label', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='label'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='label', fromsubclass_=False, pretty_print=True):
...
class calculationArc(arcType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='calculationArc', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='calculationArc', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='calculationArc'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='calculationArc', fromsubclass_=False, pretty_print=True):
...
class presentationArc(arcType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='proc:', name_='presentationArc', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='proc:', name_='presentationArc', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='proc:', name_='presentationArc'):
    ...
    def exportChildren(self, outfile, level, namespace_='proc:', name_='presentationArc', fromsubclass_=False, pretty_print=True):
...
GDSClassesMapping = {
    ...
    'periodOfPerformanceOrderingPeriodEndDate': dateItemType,
    ...
    'naicsDescription': stringItemType,
    ...
    'currentTotalValueOfAward': amountItemType,
    ...
    'potentialTotalValueOfAward': amountItemType,
...
def parse(inFileName, silence=False):
    ...
    if not silence:
        ...
        rootObj.export(
            ...
            namespacedef_='xmlns:proc="http://www.xbrl.org/int/proc/2006-10-25"',
            pretty_print=True)
    return rootObj
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from procurement import *\n\n')
        sys.stdout.write('import procurement as model_\n\n')
