...
class fractionItemType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='gl-plt:', name_='fractionItemType', fromsubclass_=False, pretty_print=True):
        ...
        if self.numerator is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%snumerator>%s</%snumerator>%s' % (namespace_, self.gds_format_float(self.numerator, input_name='numerator'), namespace_, eol_))
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'numerator':
            ...
            fval_ = self.gds_validate_float(fval_, node, 'numerator')
            self.numerator = fval_
...
class contextPeriodType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='gl-plt:', name_='contextPeriodType', fromsubclass_=False, pretty_print=True):
        ...
        if self.forever is not None:
            showIndent(outfile, level, pretty_print)
            outfile.write('<%sforever>%s</%sforever>%s' % (namespace_, self.gds_format_string(quote_xml(self.forever).encode(ExternalEncoding), input_name='forever'), namespace_, eol_))
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'startDate':
            ...
            forever_ = child_.text
            forever_ = self.gds_validate_string(forever_, node, 'forever')
            self.forever = forever_
...
class forever(GeneratedsSuper):
    ...
    def factory(*args_, **kwargs_):
        if forever.subclass:
            return forever.subclass(*args_, **kwargs_)
        else:
            return forever(*args_, **kwargs_)
    factory = staticmethod(factory)
    def hasContent_(self):
        if (
...
class measuresType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='gl-plt:', name_='measuresType', fromsubclass_=False, pretty_print=True):
        ...
        for measure_ in self.measure:
            measure_.export(outfile, level, namespace_='xbrli:', name_='measure', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
...
class roleType(GeneratedsSuper):
    ...
    def exportChildren(self, outfile, level, namespace_='gl-plt:', name_='roleType', fromsubclass_=False, pretty_print=True):
        ...
        for usedOn_ in self.usedOn:
            usedOn_.export(outfile, level, namespace_='link:', name_='usedOn', pretty_print=pretty_print)
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
        for child in node:
    ...
    def buildChildren(self, child_, node, nodeName_, fromsubclass_=False):
        if nodeName_ == 'definition':
            ...
            obj_ = QName.factory()
            obj_.build(child_)
            self.usedOn.append(obj_)
            obj_.original_tagname_ = 'usedOn'
# end class roleType
