...
#   ../schema/xbrl/award/da-award-content-2015-06-29.xsd
#
# Command line:
#   /Users/rebeccasweger/Dev/.virtualenvs/intercessor/lib/python2.7/site-packages/generateDS-2.17a0/generateDS.py -o "award.py" -q -f --no-dates --no-versions ../schema/xbrl/award/da-award-content-2015-06-29.xsd
#
...
class highlyCompensatedOfficerComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='highlyCompensatedOfficerComplexType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='highlyCompensatedOfficerComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='highlyCompensatedOfficerComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (self.gds_format_string(quote_attrib(self.id).encode(ExternalEncoding), input_name='id'), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='highlyCompensatedOfficerComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class decimalItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='decimalItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            ...
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='decimalItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='decimalItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='decimalItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class floatItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='floatItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='floatItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='floatItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='floatItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class doubleItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='doubleItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='doubleItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='doubleItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='doubleItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class monetaryItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='monetaryItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='monetaryItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='monetaryItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='monetaryItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class sharesItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='sharesItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='sharesItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='sharesItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='sharesItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class pureItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='pureItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='pureItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='pureItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='pureItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class fractionItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='fractionItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='fractionItemType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='fractionItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.id is not None and 'id' not in already_processed:
        ...
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='fractionItemType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class integerItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='integerItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='integerItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='integerItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='integerItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class nonPositiveIntegerItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='nonPositiveIntegerItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='nonPositiveIntegerItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='nonPositiveIntegerItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='nonPositiveIntegerItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class negativeIntegerItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='negativeIntegerItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='negativeIntegerItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='negativeIntegerItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='negativeIntegerItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class longItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='longItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='longItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='longItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='longItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class intItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='intItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='intItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='intItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='intItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class shortItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='shortItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='shortItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='shortItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='shortItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class byteItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='byteItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='byteItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='byteItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='byteItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class nonNegativeIntegerItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='nonNegativeIntegerItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='nonNegativeIntegerItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='nonNegativeIntegerItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='nonNegativeIntegerItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class unsignedLongItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='unsignedLongItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='unsignedLongItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='unsignedLongItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='unsignedLongItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class unsignedIntItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='unsignedIntItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='unsignedIntItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='unsignedIntItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='unsignedIntItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class unsignedShortItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='unsignedShortItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='unsignedShortItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='unsignedShortItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='unsignedShortItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class unsignedByteItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='unsignedByteItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='unsignedByteItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='unsignedByteItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='unsignedByteItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class positiveIntegerItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='positiveIntegerItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='positiveIntegerItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='positiveIntegerItemType'):
        if self.unitRef is not None and 'unitRef' not in already_processed:
            already_processed.add('unitRef')
            outfile.write(' unitRef=%s' % (quote_attrib(self.unitRef), ))
        if self.decimals is not None and 'decimals' not in already_processed:
        ...
        if self.precision is not None and 'precision' not in already_processed:
            already_processed.add('precision')
            outfile.write(' precision=%s' % (quote_attrib(self.precision), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='positiveIntegerItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class stringItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='stringItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='stringItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='stringItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='stringItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class booleanItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='booleanItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='booleanItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='booleanItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='booleanItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class hexBinaryItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='hexBinaryItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='hexBinaryItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='hexBinaryItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='hexBinaryItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class base64BinaryItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='base64BinaryItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='base64BinaryItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='base64BinaryItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='base64BinaryItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class anyURIItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='anyURIItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='anyURIItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='anyURIItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='anyURIItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class QNameItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='QNameItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='QNameItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='QNameItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='QNameItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class durationItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='durationItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='durationItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='durationItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='durationItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class dateTimeItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='dateTimeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='dateTimeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='dateTimeItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='dateTimeItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class timeItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='timeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='timeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='timeItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='timeItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class dateItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='dateItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='dateItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='dateItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='dateItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class gYearMonthItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='gYearMonthItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='gYearMonthItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='gYearMonthItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='gYearMonthItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class gYearItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='gYearItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='gYearItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='gYearItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='gYearItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class gMonthDayItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='gMonthDayItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='gMonthDayItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='gMonthDayItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='gMonthDayItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class gDayItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='gDayItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='gDayItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='gDayItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='gDayItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class gMonthItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='gMonthItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='gMonthItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='gMonthItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='gMonthItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class normalizedStringItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='normalizedStringItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='normalizedStringItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='normalizedStringItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='normalizedStringItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class tokenItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='tokenItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='tokenItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='tokenItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def exportChildren(self, outfile, level, namespace_='award:', name_='tokenItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class languageItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='languageItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='languageItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='languageItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='languageItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class NameItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='NameItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='NameItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='NameItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='NameItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class NCNameItemType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='NCNameItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='NCNameItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='NCNameItemType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
        if self.contextRef is not None and 'contextRef' not in already_processed:
            already_processed.add('contextRef')
            outfile.write(' contextRef=%s' % (quote_attrib(self.contextRef), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='NCNameItemType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class segment(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='segment', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='segment', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='segment'):
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='segment', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class contextEntityType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='contextEntityType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='contextEntityType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='contextEntityType'):
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='contextEntityType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class contextPeriodType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='contextPeriodType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='contextPeriodType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='contextPeriodType'):
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='contextPeriodType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class contextScenarioType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='contextScenarioType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='contextScenarioType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='contextScenarioType'):
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='contextScenarioType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class context(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='context', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='context', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='context'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='context', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class measuresType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='measuresType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='measuresType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='measuresType'):
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='measuresType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class divide(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='divide', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='divide', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='divide'):
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='divide', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class unit(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='unit', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='unit', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='unit'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='unit', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class xbrl(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='xbrl', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xbrli="http://www.xbrl.org/2003/instance" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='xbrl', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='xbrl'):
        unique_counter = 0
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='xbrl', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class presentationLink(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='presentationLink', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='presentationLink', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='presentationLink'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='presentationLink', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class definitionLink(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='definitionLink', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='definitionLink', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='definitionLink'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='definitionLink', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class calculationLink(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='calculationLink', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='calculationLink', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='calculationLink'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='calculationLink', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class labelLink(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='labelLink', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='labelLink', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='labelLink'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='labelLink', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class referenceLink(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='referenceLink', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='referenceLink', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='referenceLink'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='referenceLink', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class footnoteLink(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='footnoteLink', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='footnoteLink', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='footnoteLink'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='footnoteLink', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class linkbase(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='linkbase', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='linkbase', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='linkbase'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='linkbase', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class linkbaseRef(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='linkbaseRef', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='linkbaseRef', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='linkbaseRef'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='linkbaseRef', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class roleType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='roleType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='roleType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='roleType'):
        ...
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='roleType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class arcroleType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='arcroleType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='arcroleType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='arcroleType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='arcroleType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class documentationType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='documentationType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='documentationType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='documentationType'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
                ...
                if mo is not None:
                    ...
                    if name not in already_processed:
                        ...
                        outfile.write(' %s=%s' % (
                            name, quote_attrib(value), ))
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='documentationType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class titleType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='titleType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='titleType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='titleType'):
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_format_string(quote_attrib(self.type_).encode(ExternalEncoding), input_name='type'), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='titleType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class locatorType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='locatorType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='locatorType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='locatorType'):
        ...
        if self.type_ is not None and 'type_' not in already_processed:
            already_processed.add('type_')
            outfile.write(' type=%s' % (self.gds_format_string(quote_attrib(self.type_).encode(ExternalEncoding), input_name='type'), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='locatorType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class arcType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='arcType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='arcType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='arcType'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def exportChildren(self, outfile, level, namespace_='award:', name_='arcType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class resourceType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='resourceType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='resourceType'):
        if self.role is not None and 'role' not in already_processed:
            already_processed.add('role')
            outfile.write(' role=%s' % (self.gds_format_string(quote_attrib(self.role).encode(ExternalEncoding), input_name='role'), ))
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def exportChildren(self, outfile, level, namespace_='award:', name_='resourceType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class extendedType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='extendedType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:xl="http://www.xbrl.org/2003/XLink" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='extendedType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='extendedType'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
        ...
        if self.title_attr is not None and 'title_attr' not in already_processed:
            already_processed.add('title_attr')
            outfile.write(' title=%s' % (self.gds_format_string(quote_attrib(self.title_attr).encode(ExternalEncoding), input_name='title_attr'), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='extendedType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class simpleType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='simpleType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='simpleType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='simpleType'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
        ...
        if self.extensiontype_ is not None and 'xsi:type' not in already_processed:
            ...
            outfile.write(' xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"')
            outfile.write(' xsi:type="%s"' % self.extensiontype_)
    def exportChildren(self, outfile, level, namespace_='award:', name_='simpleType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class accountPurposeCodeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='accountPurposeCodeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='accountPurposeCodeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='accountPurposeCodeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='accountPurposeCodeItemType', fromsubclass_=False, pretty_print=True):
...
class accountTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='accountTypeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='accountTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='accountTypeItemType'):
        super(accountTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='accountTypeItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='accountTypeItemType', fromsubclass_=False, pretty_print=True):
...
class bookTaxDifferenceItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='bookTaxDifferenceItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='bookTaxDifferenceItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='bookTaxDifferenceItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='bookTaxDifferenceItemType', fromsubclass_=False, pretty_print=True):
...
class identifierOrganizationTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='identifierOrganizationTypeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='identifierOrganizationTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='identifierOrganizationTypeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='identifierOrganizationTypeItemType', fromsubclass_=False, pretty_print=True):
...
class debitCreditCodeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='debitCreditCodeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='debitCreditCodeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='debitCreditCodeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='debitCreditCodeItemType', fromsubclass_=False, pretty_print=True):
...
class documentTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='documentTypeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='documentTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='documentTypeItemType'):
        super(documentTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='documentTypeItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='documentTypeItemType', fromsubclass_=False, pretty_print=True):
...
class invoiceTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='invoiceTypeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='invoiceTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='invoiceTypeItemType'):
        super(invoiceTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='invoiceTypeItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='invoiceTypeItemType', fromsubclass_=False, pretty_print=True):
...
class entriesTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='entriesTypeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='entriesTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='entriesTypeItemType'):
        super(entriesTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='entriesTypeItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='entriesTypeItemType', fromsubclass_=False, pretty_print=True):
...
class entryTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='entryTypeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='entryTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='entryTypeItemType'):
        super(entryTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='entryTypeItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='entryTypeItemType', fromsubclass_=False, pretty_print=True):
...
class identifierTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='identifierTypeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='identifierTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='identifierTypeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='identifierTypeItemType', fromsubclass_=False, pretty_print=True):
...
class mainAccountTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='mainAccountTypeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='mainAccountTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='mainAccountTypeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='mainAccountTypeItemType', fromsubclass_=False, pretty_print=True):
...
class postingStatusItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='postingStatusItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='postingStatusItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='postingStatusItemType'):
        super(postingStatusItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='postingStatusItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='postingStatusItemType', fromsubclass_=False, pretty_print=True):
...
class qualifierEntryItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='qualifierEntryItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='qualifierEntryItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='qualifierEntryItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='qualifierEntryItemType', fromsubclass_=False, pretty_print=True):
...
class revisesUniqueIDActionItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='revisesUniqueIDActionItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='revisesUniqueIDActionItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='revisesUniqueIDActionItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='revisesUniqueIDActionItemType', fromsubclass_=False, pretty_print=True):
...
class signOfAmountItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='signOfAmountItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='signOfAmountItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='signOfAmountItemType'):
        super(signOfAmountItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='signOfAmountItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='signOfAmountItemType', fromsubclass_=False, pretty_print=True):
...
class sourceJournalIDItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='sourceJournalIDItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='sourceJournalIDItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='sourceJournalIDItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='sourceJournalIDItemType', fromsubclass_=False, pretty_print=True):
...
class xbrlIncludeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='xbrlIncludeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='xbrlIncludeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='xbrlIncludeItemType'):
        super(xbrlIncludeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='xbrlIncludeItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='xbrlIncludeItemType', fromsubclass_=False, pretty_print=True):
...
class phoneNumberDescriptionItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='phoneNumberDescriptionItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='phoneNumberDescriptionItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='phoneNumberDescriptionItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='phoneNumberDescriptionItemType', fromsubclass_=False, pretty_print=True):
...
class availableTypeCodeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='availableTypeCodeItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='availableTypeCodeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='availableTypeCodeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='availableTypeCodeItemType', fromsubclass_=False, pretty_print=True):
...
class TreasuryAccountSymbolComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='TreasuryAccountSymbolComplexType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:gen="http://www.xbrl.org/int/gl/gen/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='TreasuryAccountSymbolComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='TreasuryAccountSymbolComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='TreasuryAccountSymbolComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class addressComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='addressComplexType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:gen="http://www.xbrl.org/int/gl/gen/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='addressComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='addressComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='addressComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class streetAddressComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='streetAddressComplexType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:gen="http://www.xbrl.org/int/gl/gen/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='streetAddressComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='streetAddressComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='streetAddressComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class agencyComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='agencyComplexType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:gen="http://www.xbrl.org/int/gl/gen/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='agencyComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='agencyComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='agencyComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class agencyOfficeComplexType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='agencyOfficeComplexType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25" xmlns:gen="http://www.xbrl.org/int/gl/gen/2006-10-25" ', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='agencyOfficeComplexType', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='agencyOfficeComplexType'):
        if self.id is not None and 'id' not in already_processed:
            already_processed.add('id')
            outfile.write(' id=%s' % (quote_attrib(self.id), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='agencyOfficeComplexType', fromsubclass_=False, pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
...
class amountItemType(monetaryItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='amountItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='amountItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='amountItemType'):
        super(amountItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='amountItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='amountItemType', fromsubclass_=False, pretty_print=True):
...
class congressionalDistrictItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='congressionalDistrictItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='congressionalDistrictItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='congressionalDistrictItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='congressionalDistrictItemType', fromsubclass_=False, pretty_print=True):
...
class stateItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='stateItemType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='stateItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='stateItemType'):
        super(stateItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='stateItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='stateItemType', fromsubclass_=False, pretty_print=True):
...
class identifierType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='identifierType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='identifierType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='identifierType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='identifierType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class foreverType(GeneratedsSuper):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='foreverType', namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='foreverType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='foreverType'):
        pass
    def exportChildren(self, outfile, level, namespace_='award:', name_='foreverType', fromsubclass_=False, pretty_print=True):
        pass
    def build(self, node):
        already_processed = set()
        self.buildAttributes(node, node.attrib, already_processed)
...
class arcroleRef(simpleType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='arcroleRef', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='arcroleRef', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='arcroleRef'):
        super(arcroleRef, self).exportAttributes(outfile, level, already_processed, namespace_, name_='arcroleRef')
        if self.arcroleURI is not None and 'arcroleURI' not in already_processed:
            already_processed.add('arcroleURI')
            outfile.write(' arcroleURI=%s' % (quote_attrib(self.arcroleURI), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='arcroleRef', fromsubclass_=False, pretty_print=True):
...
class roleRef(simpleType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='roleRef', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='roleRef', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='roleRef'):
        super(roleRef, self).exportAttributes(outfile, level, already_processed, namespace_, name_='roleRef')
        if self.roleURI is not None and 'roleURI' not in already_processed:
            already_processed.add('roleURI')
            outfile.write(' roleURI=%s' % (quote_attrib(self.roleURI), ))
    def exportChildren(self, outfile, level, namespace_='award:', name_='roleRef', fromsubclass_=False, pretty_print=True):
...
class footnote(resourceType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='footnote', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='footnote', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='footnote'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='footnote', fromsubclass_=False, pretty_print=True):
...
class reference(resourceType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='reference', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='reference', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='reference'):
        super(reference, self).exportAttributes(outfile, level, already_processed, namespace_, name_='reference')
    def exportChildren(self, outfile, level, namespace_='award:', name_='reference', fromsubclass_=False, pretty_print=True):
...
class label(resourceType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='label', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='label', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='label'):
        unique_counter = 0
        for name, value in self.anyAttributes_.items():
            xsinamespaceprefix = 'xsi'
            xsinamespace1 = 'http://www.w3.org/2001/XMLSchema-instance'
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='label', fromsubclass_=False, pretty_print=True):
...
class calculationArc(arcType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='calculationArc', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='calculationArc', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='calculationArc'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='calculationArc', fromsubclass_=False, pretty_print=True):
...
class presentationArc(arcType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='presentationArc', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>%s' % (eol_, ))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='presentationArc', pretty_print=pretty_print)
            showIndent(outfile, level, pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='presentationArc'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='presentationArc', fromsubclass_=False, pretty_print=True):
...
class typeOfTransactionCodeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='typeOfTransactionCodeItemType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='typeOfTransactionCodeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='typeOfTransactionCodeItemType'):
    ...
    def exportChildren(self, outfile, level, namespace_='award:', name_='typeOfTransactionCodeItemType', fromsubclass_=False, pretty_print=True):
...
class typeOfActionItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='typeOfActionItemType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='typeOfActionItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='typeOfActionItemType'):
        super(typeOfActionItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='typeOfActionItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='typeOfActionItemType', fromsubclass_=False, pretty_print=True):
...
class recordTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='recordTypeItemType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='recordTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='recordTypeItemType'):
        super(recordTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='recordTypeItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='recordTypeItemType', fromsubclass_=False, pretty_print=True):
...
class businessTypeItemType(tokenItemType):
    ...
    def hasContent_(self):
        if (
            ...
            return False
    def export(self, outfile, level, namespace_='award:', name_='businessTypeItemType', namespacedef_='', pretty_print=True):
        if pretty_print:
            eol_ = '\n'
        else:
            eol_ = ''
        ...
        if self.hasContent_():
            outfile.write('>')
            outfile.write(str(self.valueOf_).encode(ExternalEncoding))
            self.exportChildren(outfile, level + 1, namespace_='award:', name_='businessTypeItemType', pretty_print=pretty_print)
            outfile.write('</%s%s>%s' % (namespace_, name_, eol_))
        else:
            outfile.write('/>%s' % (eol_, ))
    def exportAttributes(self, outfile, level, already_processed, namespace_='award:', name_='businessTypeItemType'):
        super(businessTypeItemType, self).exportAttributes(outfile, level, already_processed, namespace_, name_='businessTypeItemType')
    def exportChildren(self, outfile, level, namespace_='award:', name_='businessTypeItemType', fromsubclass_=False, pretty_print=True):
...
def parse(inFileName, silence=False):
    ...
    if rootClass is None:
        rootTag = 'businessTypeItemType'
        rootClass = businessTypeItemType
    ...
    if not silence:
        ...
        rootObj.export(
            ...
            namespacedef_='xmlns:award="http://www.xbrl.org/int/award/2006-10-25"',
            pretty_print=True)
    return rootObj
...
def parseLiteral(inFileName, silence=False):
    ...
    doc = None
    if not silence:
        sys.stdout.write('#from award import *\n\n')
        sys.stdout.write('import award as model_\n\n')
